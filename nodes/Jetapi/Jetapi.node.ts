	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						value: 'cascade',
						description:
							'Auto-select channel based on your account settings and channel priority configured in JetAPI dashboard',
					},
				],
				default: 'whatsapp',
				required: true,
			...
			},
			{
				...
				required: true,
				description:
					'Message text (3500 chars for messengers, 160 for SMS). See <a href="https://docs.jetapi.io/#ea49fe72-5621-405c-ba99-8450050a35ff" target="_blank">documentation</a> for more details.',
			},
			{
				...
				options: [
					...
					},
					{
						...
						type: 'boolean',
						default: true,
						description: 'Whether to simulate typing in WhatsApp (default: true)',
					},
					{
		...
		for (let i = 0; i < items.length; i++) {
			try {
				...
				if (operation === 'sendText') {
					...
					const requestBody: IDataObject = { text };
